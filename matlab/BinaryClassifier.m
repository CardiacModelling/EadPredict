...
redferns(redferns==2) = 1;
redferns(redferns==3) = 1;
redferns(redferns==4) = 0;
redferns(redferns==5) = 0;
...
%% create output files
lda_filename = strcat(start,'bin_wc_lda_results.tsv');
lda_file = fopen(lda_filename,'w+');
svm_filename = strcat(start,'bin_wc_svm_results.tsv');
...
key_filename = strcat(start,'bin_lda_svm_key.tsv');
